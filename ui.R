  ...
  titlePanel("Loan Rangers Project"),
            sidebarLayout(sidebarPanel(
               ...
               radioButtons("purpose", "Purpose of Loan", choices = c("Credit Card" = "credit_card", "Car" = "car", "Small Business" = "small_business",
                ...
                textInput("desc", "Loan Description", value="Need to pay bills", placeholder = "What do you need the money for?"),
            ...
            mainPanel(
              ...
              tabPanel("Default Risk",h3(textOutput("res")), plotlyOutput("rel_numv"),
                       plotlyOutput("rel_purpose"), plotlyOutput("rel_empl"), h3(textOutput("textanalysis")), span(textOutput("textb"), style="color:blue"))
              )
            ))))
